    ...
    <section className="container py-10">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {MLBB_ACCOUNTS.map((akun) => (
          <Link key={akun.id} href={`/akun/mlbb/${akun.id}`} className="rounded-2xl overflow-hidden shadow-lg bg-white hover:-translate-y-1 transition">
            ...
            <div className="p-4 text-center">
              ...
              <div className="mt-2 text-sm text-sky-700 font-medium underline">Lihat Detail →</div>
            </div>
          </Link>
        ))}
      </div>
